...
\begin{problem}
    (Adapted from Hartshorne, \emph{Geometry: Euclid and Beyond},
    Exercise 47.7.) Prove that the composition of two rotations of a sphere is
    another rotation of the sphere.
\end{problem}
