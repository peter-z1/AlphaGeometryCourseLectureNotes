...
\begin{problem}
    The goal of this week will be to create some training data for the language model. See \href{https://ai.google.dev/gemma/docs/tune}{Google's Gemma fine-tuning overview}. The particular thing that we are interested in is the training data. In particular, the input text should be of the form
    \begin{itemize}
