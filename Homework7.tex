...
\begin{problem}
We will start to build some artificial data to train the model starting next week. Thus, in order to get that you need your \verb|construction.py| file to have different constructions. There is a list of constructions in the extended table 1 in the alphageometry paper, but here are several of the constructions that you should have, but feel free to have more if you would like (The way you implement this is up to you, but there are general outlines below; although you may want to do things like make sure that the point you are constructing isn't already there):
