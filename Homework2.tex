...
\begin{problem}
    (Euclid, \emph{Elements}, Book VI, Proposition 4.) Suppose that
    $\triangle ABC$ and $\triangle DEF$ are equiangular, with corresponding
    vertices $A\leftrightarrow D$, $B\leftrightarrow E$, and
    $C\leftrightarrow F$. Prove that $AB/DE = BC/EF = AC/DF$.
\end{problem}
...
\begin{problem}
Prove the following theorem in formal language. (You may use AR.) The line
through $D,E,F$ is called the Wallace--Simson line.
